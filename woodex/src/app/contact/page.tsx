  ...
  return (
    <>
      ...
      <PageHero
        ...
        imageAlt="Boutique hospitality lobby with sculptural walnut reception desk and bronze screen"
        crumbs={[
          { name: "Home", path: "/" },
          { name: "Contact", path: "/contact" },
        ]}
          ...
          <div className="grid gap-x-12 gap-y-16 lg:grid-cols-12">
            ...
            <Reveal className="lg:col-span-7 lg:col-start-6">
              <SplitLines
                as="h2"
                className="t-h2"
                lines={[<>Tell us what&apos;s</>, <>not <span className="t-aside !text-bronze">working</span>.</>]}
              />
