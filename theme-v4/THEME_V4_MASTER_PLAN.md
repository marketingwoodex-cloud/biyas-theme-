...
| Version | 4.1 — Phase 1 (Static Build) + old-site content integration |
| Date | 2026-08-25 |
...
## 14. Changelog — V4.1 (old-design content integration)
Reference source: `10-original-html-non-conversion.zip` (the original static site, reviewed on request).

**Home** — rebuilt to the original narrative: hero line *"Where art becomes presence."*
with the original lede; numbered scenes (01 Opening "Not decoration. A presence." ·
02 Craft "Every thread has a direction." · quote scene · 03 Selected works with the
original titles *Language of Light / The Flower Remembers / After the Verse / Night of
Light* · 04 Poet's voice with *ishq / tasveer* floating words · 05 Founder
"A poet's heart. An artist's eye." · 06 Services drift with numbered paths ·
final band *"Art is not only seen. It is lived with."*).

**Visit** — new private-viewing model: hero "Come closer to the work"; the three
*ways in* (Private viewing / Art advisory / Studio & culture); *What to expect* ritual
(3 steps); full appointment form (intention, date, morning/afternoon/evening, note)
with trust notes (private & personal · no obligation · reply within 2 working days).

**Commissions** — added *The suite* (01 Original art · 02 Bespoke commission ·
03 Thread Art · 04 Culture & curation), the *Why the house* trio (ONE artist-led ·
HAND made with intention · HERE rooted in culture) and the trust notes.

**Poetry / Poem detail** — replaced placeholder verse with the **published Folk Punjab
archive**: ghazals *Aa jande ne khayal tasveer ban ke* (Thoughts arrive as pictures) and
*Chup chupite hijar mareela seh gai aan*; nazams *Jiwan di be rangi*, *Suhagan te waragan*;
archive links point to folkpunjab.org pending exact-page links.

**Biography** — sourced facts: Naghmana Khursheed (known as Biya Jee); poet, fiction
writer, social worker, columnist; three published Punjabi collections; documented by
Folk Punjab; Chairperson of Punjabi Virsa; President of Arts & Culture; 2024 Qasim Ali
Shah Foundation interview. Voice band now uses the published ghazal line.

**Verha events** — added GATHER · LISTEN · LOOK strip, *Ways to gather* programmes
(Mehfil & readings / Artist conversations / Salon gatherings) and guest-list CTA.

**Media** — added the real 2024 Qasim Ali Shah Foundation interview row and the
Folk Punjab archive row. **Third Art** — premise copy enriched with the original
observation line (petals, leaves, shadow, colour).

Verification state: biographical claims above are taken from the client's own original
site and remain **Pending Verification** per §2 until sources are countersigned.
